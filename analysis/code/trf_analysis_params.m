...
% tempvars generated by this script that we probably want clear when running
% script in context outside of main trf_analysis script:
% do_nulltest, train_params, show_tuning_curves
%%%%%%%%%%%%%%%%%%%%%%%%%%%%% NOTES %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if exist("trf_config_","var")
    ...
    disp(['(ignore above hash lookup result, generated in ' ...
        'trf_analysis_params as intermediate step to retrieve best_lam)'])
    train_params.best_lam=plot_lambda_tuning_curve(S_.stats_obs,S_.config);
    if ~exist('show_tuning_curves','var')
