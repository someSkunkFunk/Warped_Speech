function preprocess_config=config_preprocess2(subj)
% interp bad chans always true - save results in new directory
global user_profile
global boxdir_lab
global boxdir_mine
...
preprocessed_eeg_dir=sprintf('%spreprocessed_eeg_interpBadChans/',datafolder);
