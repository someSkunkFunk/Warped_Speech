...
for dd=1:length(D)
    ...
    disp('old_hash:')
    disp(old_hash)
    %%%%% UPDATE OLD CONFIG TO HAVE A CONSISTENT STRUCTURE WITH NEW%%%%%%%%
    ...
    old_config=columnize_row_vectors(old_config);
...
% if no early return from replacing configs occurs, none were updated ->
% notify
