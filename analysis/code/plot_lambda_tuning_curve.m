function plot_lambda_tuning_curve(stats_obs,trf_config,plot_ch)
...
legend('tuning curve',sprintf('max r: %0.2g, \\lambda:%0.2g',r_max,trf_config.lam_range(best_lam_idx)))
